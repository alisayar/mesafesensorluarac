...
public class UI_Main extends javax.swing.JFrame implements SerialPortEventListener {
    ...
    int i = 0;
    private static String comPortName = "COM8";//BU BİLGİYİ FORM DAN DA ALABİLİRİZ
...
DefaultListModel model = new DefaultListModel();  
    ...
    private void initComponents() {
        ...
        txtReadData.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtReadDataKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtReadDataKeyReleased(evt);
            }
        });
    ...
    //37 -38 -39- 40 _> sol -üst-sag-alt
    private void txtReadDataKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtReadDataKeyPressed
        // TODO add your handling code here:
        System.out.println("kutunun içinde tuşa basıldı:"+evt.getKeyCode());
    ...
    }//GEN-LAST:event_txtReadDataKeyPressed

    private void txtReadDataKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtReadDataKeyReleased
        // TODO add your handling code here:
        System.out.println("kutunun içinde tuşa ÇEKİLDİS:"+evt.getKeyCode());
        switch(evt.getKeyCode()){
             case 37://sola
                  try {
                        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_txtReadDataKeyReleased
